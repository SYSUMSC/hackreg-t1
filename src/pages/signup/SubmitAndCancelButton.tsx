...
const SubmitAndCancelButton: FunctionComponent<IProps> = ({ formik, confirmed, onCancel, erroredAction }) => {
    ...
    return (<>
        ...
        {
            erroredAction ? (<>
                <Overlay target={target.current!} show={!!erroredAction.errorMessage} placement="bottom">
