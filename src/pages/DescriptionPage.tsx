...
const DescriptionPage: FunctionComponent = () => (<>
    ...
    <Container fluid={true} className="content-item">
        <Row>
            <Col as="h2"><span className="font-weight-light">黑客松，</span>是什么？</Col>
        </Row>
        <Row>
            <Col sm={6}>
            ...
            <Col sm={6}>
                <img className="img-fluid" src={whatIsHackathon} alt="What is Hackathon" />
            </Col>
        </Row>
    </Container>
    <Container fluid={true} className="content-item custom-bg-gray">
        <Row>
            <Col as="h2"><span className="font-weight-light">那么，</span>谁能参加呢？</Col>
        </Row>
        <Row>
            <Col sm={4}>
                <h4>在校带学生</h4>
    ...
    <Container fluid={true} className="content-item">
        <Row>
            <Col as="h2"><span className="font-weight-light">我...还有点</span>犹豫。</Col>
        </Row>
        <Row>
            <Col sm={6}>
                <h4>我够格吗？</h4>
    ...
    <Container fluid={true} className="content-item custom-bg-green">
        <Row>
            <Col as="h2" className="text-white"><span className="font-weight-light">既然如此，</span>我想来试试！</Col>
        </Row>
        <Row>
            <Col className="text-white">
                找几个小伙伴组个队伍，然后
                <u><Link to="/signup" className="text-white">点击这里</Link></u>
                填写报名表吧！
            </Col>
        </Row>
    </Container>
    <Container fluid={true} className="content-item">
        <Row>
            <Col as="h2"><span className="font-weight-light">比赛赞助商</span></Col>
        </Row>
        <Row>
            <Col>
